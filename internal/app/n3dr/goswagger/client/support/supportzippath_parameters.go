...
func (o *SupportzippathParams) WithBody(body *models.SupportZipGeneratorRequest) *SupportzippathParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the supportzippath params
func (o *SupportzippathParams) SetBody(body *models.SupportZipGeneratorRequest) {
	o.Body = body
}
